...
def pro_sales_menu():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("💎 Купить PRO — 67 ⭐", callback_data="pro_buy")],
...
def main():
    ...
    app.add_handler(MessageHandler(filters.SUCCESSFUL_PAYMENT, pro_successful_payment))
